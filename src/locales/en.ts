export default {
    ...
    home: {
        ...
        tools: {
            ...
            subtitle: "Powerful AI tools to grow your TikTok presence",
            viewAll: "View All Tools"
        },
        mostDownloaded: {
            title: "Most Downloaded This Week",
            video1: { caption: "This move broke the internet!", badge: "🔥 Trending" },
            video2: { caption: "Cooking disaster 😂", badge: "😆 Most Shared" },
            video3: { caption: "Bali sunsets are undefeated 🌅", badge: "🌍 Most Saved" },
            video4: { caption: "Outfit ideas for your next date 💅", badge: "✨ Editor's Pick" },
        },
        testimonials: {
            title: "What Our Users Say",
            user1: "The fastest TikTok downloader I've used. No ads, no BS.",
            user2: "Love the clean UI and dark mode. Privacy is 🔥.",
    ...
    tools: {
        page: {
            title: "Free TikTok Tools",
            description: "Powerful AI-powered tools to grow your TikTok presence and analyze your content",
            freeToUse: "100% Free",
            aiPowered: "AI Powered",
            popular: "Popular",
            new: "New",
            tryNow: "Try Now",
            ctaTitle: "Need to Download TikTok Videos?",
            ctaDescription: "Use our lightning-fast downloader to save any TikTok video without watermarks.",
            downloadVideos: "Download Videos Free"
        },
        share: {
            download: "Download Image",
            downloading: "Downloading...",
            downloaded: "Downloaded!",
            downloadedDesc: "Image saved to your device",
            twitter: "Share on X",
            copyLink: "Copy Link",
            defaultText: "Check out my results from Tiklink!"
        },
        // Money Calculator
        "money-calculator": {
            title: "Money Calculator",
            shortDesc: "Calculate how much TikTokers earn based on followers and engagement",
            description: "Discover how much TikTok creators earn monthly based on their followers, views, and engagement rate.",
            formTitle: "Enter Creator Stats",
            formDescription: "Adjust the sliders to estimate TikTok earnings",
            followers: "Followers",
            avgViews: "Average Views per Video",
            ...
            creatorFundDesc: "Based on views",
            creatorFundInfo: "TikTok pays $0.02-$0.04 per 1,000 views through the Creator Fund. Eligibility requires 10K+ followers and 100K views in 30 days.",
            sponsorships: "Sponsorships",
            sponsorshipsDesc: "Brand deals potential",
            sponsorshipsInfo: "Sponsorship rates vary by niche, engagement, and follower count. Micro-influencers can earn $100-$500 per post, while mega-influencers earn $10K+.",
            liveGifts: "Live Gifts",
            liveGiftsDesc: "From live streams",
            liveGiftsInfo: "Viewers can send virtual gifts during live streams. Creators keep about 50% of the gift value after TikTok's cut.",
            yearlyProjection: "Yearly Projection",
            yearlyDesc: "Potential annual earnings",
            shareResults: "Share Results",
            shareTitle: "TikTok Earnings Calculator",
            shareText: "I could earn {{min}} - {{max}}/month on TikTok! 💰 Calculate yours:",
            disclaimer: "These are estimates based on industry averages. Actual earnings vary based on niche, content quality, posting consistency, and many other factors.",
            howItWorks: "How TikTok Money Works",
            growthTips: "Growth Tips",
            growthTipsInfo: "Consistency is key! Post 1-3 times daily, engage with comments, use trending sounds, and collaborate with other creators to grow faster."
        },
        // Best Time to Post
        "best-time-to-post": {
            title: "Best Time to Post",
            shortDesc: "Find the optimal posting times for your TikTok niche and audience",
            description: "Discover when your audience is most active and maximize your content's reach",
            configTitle: "Configure Your Profile",
            configDescription: "Tell us about your content and audience",
            timezone: "Your Timezone",
            niche: "Content Niche",
            audience: "Target Audience",
            generate: "Generate Schedule",
            peakHours: "Peak Hours",
            peakHoursDesc: "Best times to post for maximum engagement",
            avoidHours: "Avoid These Hours",
            avoidHoursDesc: "Lower engagement during these times",
            weeklySchedule: "Weekly Schedule",
            weeklyScheduleDesc: "Engagement scores by hour (higher is better)",
            peak: "Peak",
            good: "Good",
            average: "Average",
            low: "Low",
            proTips: "Pro Tips for Your Schedule"
        },
        // Hashtag Generator
        "hashtag-generator": {
            title: "Hashtag Generator",
            shortDesc: "AI-powered hashtags to boost your video's discoverability",
            description: "Generate optimized hashtags that help your TikToks reach the right audience",
            formTitle: "Generate Perfect Hashtags",
            formDescription: "Enter your video topic and we'll suggest the best hashtags",
            topicLabel: "Topic or Niche",
            topicPlaceholder: "e.g., fitness tips, cooking recipes, dance tutorials...",
            styleLabel: "Hashtag Style",
            generate: "Generate Hashtags",
            generating: "Generating...",
            errorTitle: "Error",
            errorEmpty: "Please enter a topic",
            errorGenerate: "Failed to generate hashtags. Please try again.",
            recommended: "Top Recommended",
            recommendedDesc: "Best hashtag combination for your topic",
            allHashtags: "All Hashtags",
            clickToCopy: "Click any hashtag to copy",
            copyAll: "Copy All",
            copiedDesc: "Hashtags copied to clipboard",
            copiedAllDesc: "All hashtags copied!",
            trending: "Trending",
            trendingDesc: "High-volume hashtags for maximum reach",
            medium: "Medium",
            mediumDesc: "Balanced competition for good visibility",
            niche: "Niche",
            nicheDesc: "Low competition for targeted reach",
            tips: "Hashtag Tips",
            tip1: "Use 3-5 hashtags per video for optimal performance",
            tip2: "Mix trending, medium, and niche hashtags",
            tip3: "Place hashtags at the end of your caption",
            tip4: "Update your hashtags weekly based on trends"
        },
        // Viral Predictor
        "viral-predictor": {
            title: "Viral Predictor",
            shortDesc: "AI predicts if your TikTok will go viral with improvement tips",
            description: "Get an AI-powered analysis of your video's viral potential and actionable improvements",
            formTitle: "Analyze Your Video",
            formDescription: "Paste a TikTok URL to get a viral score prediction",
            urlLabel: "TikTok Video URL",
            urlPlaceholder: "https://www.tiktok.com/@user/video/...",
            roastMode: "Roast Mode 🔥",
            roastModeDesc: "Get a funny roast of your video",
            analyze: "Predict Viral Score",
            fetchingVideo: "Fetching video info...",
            analyzing: "Analyzing with AI...",
            errorTitle: "Error",
            errorEmpty: "Please enter a TikTok URL",
            errorAnalyze: "Failed to analyze video. Please try again.",
            viralScore: "Viral Score",
            roastTitle: "The Roast 🔥",
            hook: "Hook (First 3 Seconds)",
            content: "Content Quality",
            engagement: "Engagement Potential",
            trending: "Trend Alignment",
            improvements: "How to Improve",
            improvementsDesc: "Actionable tips to boost your video's performance",
            shareResults: "Share My Score"
        },
        // Profile Analyzer
        "profile-analyzer": {
            title: "Profile Analyzer",
            shortDesc: "Deep analytics for any TikTok profile - engagement, growth & more",
            description: "Get comprehensive analytics for any public TikTok profile",
            formTitle: "Analyze Any Profile",
            formDescription: "Enter a TikTok username to get detailed analytics",
            ...
            shareResults: "Share Analysis"
        },
        // Bio Generator
        "bio-generator": {
            title: "Bio Generator",
            shortDesc: "AI creates catchy TikTok bios that stand out",
            description: "Generate creative, attention-grabbing bios for your TikTok profile",
            formTitle: "Create Your Perfect Bio",
            formDescription: "Tell us about yourself and we'll generate bio options",
            nicheLabel: "Your Niche",
            vibeLabel: "Personality Vibe",
            keywordsLabel: "Keywords (Optional)",
            keywordsPlaceholder: "creator, NYC, fitness lover...",
            keywordsHint: "Add specific words you want included",
            generate: "Generate Bios",
            generating: "Creating magic...",
            regenerate: "Generate More",
            errorTitle: "Error",
            errorGenerate: "Failed to generate bios. Please try again.",
            suggestedEmojis: "Emojis",
            copiedDesc: "Bio copied to clipboard!",
            tipsTitle: "Bio Best Practices"
        },
        // Username Checker
        "username-checker": {
            title: "Username Checker",
            shortDesc: "Check username availability across all social platforms",
            description: "Find if your desired username is available on TikTok, Instagram, Twitter, and more",
            formTitle: "Check Username",
            formDescription: "See if your username is available everywhere",
            placeholder: "dreamusername",
            check: "Check Availability",
            checking: "Checking...",
            errorTitle: "Error",
            errorEmpty: "Please enter a username",
            errorShort: "Username must be at least 3 characters",
            available: "Available",
            taken: "Taken",
            availableOn: "Available on {{count}}/{{total}} platforms",
            suggestions: "Try These Alternatives",
            suggestionsDesc: "Click to check availability",
            checkAnother: "Check Another Username"
        },
        // Caption Generator
        "caption-generator": {
            title: "Caption Generator",
            shortDesc: "AI-powered viral captions with proven hook formulas",
            description: "Generate engaging captions with hook analysis and engagement scores",
            formTitle: "Generate Viral Captions",
            formDescription: "Enter your video topic to get 5 unique caption options",
            topicLabel: "Video Topic",
            topicPlaceholder: "e.g., morning routine, cooking tips, fitness journey...",
            nicheLabel: "Content Niche",
            toneLabel: "Caption Tone",
            includeEmojis: "Include Emojis",
            includeHashtags: "Include Hashtags",
            includeCTA: "Include Call-to-Action",
            generate: "Generate Captions",
            generating: "Creating viral captions...",
            regenerate: "Generate More",
            errorTitle: "Error",
            errorEmpty: "Please enter a topic",
            errorGenerate: "Failed to generate captions. Please try again.",
            hookStrength: "Hook Strength",
            engagementScore: "Engagement Score",
            suggestedHashtags: "Suggested Hashtags",
            copyWithHashtags: "Copy with Hashtags",
            customize: "Customize Your Caption",
            customizeDesc: "Edit and perfect your caption",
            tips: "Caption Best Practices"
        },
        // Script Generator
        "script-generator": {
            title: "Video Script Generator",
            shortDesc: "Complete TikTok scripts with hooks, timing, and visual cues",
            description: "Generate structured video scripts with timestamps and filming tips",
            formTitle: "Create Your Script",
            formDescription: "Enter your topic and we'll generate a complete script",
            topicLabel: "Video Topic",
            topicPlaceholder: "e.g., 3 productivity tips, how to make pasta...",
            ...
            errorTitle: "Error",
            errorEmpty: "Please enter a topic",
            errorGenerate: "Failed to generate script. Please try again.",
            timeline: "Script Timeline",
            hook: "Hook",
            content: "Content",
            cta: "Call to Action",
            transition: "Transition",
            scriptSection: "Script (What to Say)",
            visualGuide: "Visual Guide (What to Show)",
            suggestedSounds: "Suggested Sounds",
        ...
        "stats-card": {
            ...
            shortDesc: "Create beautiful, shareable TikTok stats cards",
            description: "Generate stunning stats cards to showcase your TikTok achievements",
            customize: "Customize Your Card",
            customizeDesc: "Adjust your stats and choose a theme",
            username: "Username",
            theme: "Card Theme",
            followers: "Followers",
            likes: "Total Likes",
            ...
            videos: "Videos",
            preview: "Preview",
            tiktokCreator: "TikTok Creator",
            download: "Download Card",
            share: "Share",
            downloaded: "Downloaded!",
            downloadedDesc: "Card saved to your device",
            errorTitle: "Error",
            errorDownload: "Failed to download. Please try again.",
            shareTitle: "My TikTok Stats",
            shareText: "Check out {{username}}'s TikTok stats!"
        }
    },
    about: {
        title: "About Tiklink",
        ...
        posts: {
            guide: {
                ...
                content: [
                    ...
                    { type: 'blockquote', text: "The ability to download clean, high-quality video is no longer a luxury—it's a core part of a modern content strategy." },
                    ...
                    { type: 'ul', items: [
                        ...
                        "Universally Compatible: It works on any device with a web browser—iPhone, Android, PC, or Mac."
                    ]}
                ]
            },
            watermarks: {
                ...
                content: [
                    ...
                    { type: 'p', text: "Removing the watermark isn't about stealing content—it's about owning your own. Here's why downloading a clean version of your video is a non-negotiable step for any serious creator." },
    ...
    footer: {
        ...
        terms: "Terms of Use",
        contact: "Contact Us",
        tagline: "The fastest way to download social media videos.",
        sections: {
            download: "Download",
            tools: "Tools",
            company: "Company",
    ...
    pages: {
        home: {
            badge: "Tiklink",
            title: "Download any video, instantly.",
            subtitle: "No watermark. No signup. No nonsense.",
            placeholder: "Paste a video link...",
            downloadBtn: "Download",
            howTitle: "How it works",
            steps: {
                paste: { title: "Paste", desc: "Copy any video URL from your favorite platform" },
                download: { title: "Download", desc: "Choose your preferred quality and format" },
                done: { title: "Done", desc: "Video saved to your device instantly" },
            },
            moreTools: "More tools",
            exploreTools: "Explore tools",
            tools: {
                captions: { title: "AI Captions", desc: "Generate viral captions with AI for any social media platform." },
                hashtags: { title: "Hashtag Generator", desc: "Trending tags for any niche to maximize your reach." },
                mp3: { title: "Video to MP3", desc: "Extract audio from any video in seconds." },
            }
        },
        instagram: {
            ...
            faqs: [
                { q: "How do I download Instagram Reels?", a: "Simply copy the Reel URL from Instagram, paste it into the input field above, and click Download. Your video will be ready in seconds." },
                { q: "Can I download Instagram Reels without watermark?", a: "Yes, Tiklink downloads Instagram Reels in their original quality without any added watermarks." },
                { q: "Is it free to download Instagram Reels?", a: "Yes, Tiklink is completely free to use. No signup, no hidden fees." },
                { q: "Can I download private Instagram Reels?", a: "No, only publicly available Reels can be downloaded. Private accounts' content is not accessible." },
            ]
        },
        youtube: {
            ...
            faqs: [
                { q: "How do I download YouTube Shorts?", a: "Copy the YouTube Shorts URL, paste it above, and click Download. The video will be saved to your device instantly." },
                { q: "Can I download YouTube Shorts in HD?", a: "Yes, Tiklink downloads YouTube Shorts in the highest available quality." },
                { q: "Is downloading YouTube Shorts free?", a: "Yes, completely free. No account needed, no limits on downloads." },
                { q: "Can I extract audio from YouTube Shorts?", a: "Yes, when available, you'll see a Download Audio option alongside the video download." },
            ]
        },
        mp3: {
            badge: "Audio Extractor",
            title: "Video to MP3",
            description: "Extract audio from any social media video. Paste a link and download the audio track.",
            placeholder: "Paste a video link to extract audio...",
            howTitle: "How it works",
            steps: {
                paste: { title: "Paste", desc: "Copy any video URL from TikTok, Instagram, YouTube, or X" },
                extract: { title: "Extract", desc: "We extract the audio track from the video automatically" },
                download: { title: "Download", desc: "Click Download Audio to save the MP3 to your device" },
            }
        },
        captions: {
            badge: "AI Powered",
            title: "Caption Generator",
            description: "Generate viral captions for TikTok, Instagram, and YouTube with AI.",
            placeholder: "Describe your video or content...",
            niches: { general: "General", comedy: "Comedy", fitness: "Fitness", beauty: "Beauty", food: "Food", gaming: "Gaming", education: "Education", tech: "Tech", business: "Business", travel: "Travel", music: "Music", lifestyle: "Lifestyle" },
            tones: { casual: "Casual", funny: "Funny", professional: "Professional", inspirational: "Inspirational", edgy: "Edgy", excited: "Excited" },
            generating: "Generating...",
            generate: "Generate Captions",
        ...
        hashtags: {
            badge: "AI Powered",
            title: "Hashtag Generator",
            description: "Get trending hashtags for any topic to maximize your reach.",
        ...
        pro: {
            badge: "Coming Soon",
            title: "Tiklink Pro",
            subtitle: "Everything you love about Tiklink, supercharged.",
            features: {
                bulk: { title: "Bulk Downloads", desc: "Download entire profiles or collections at once. Save hours of manual work." },
                noAds: { title: "No Ads", desc: "Clean, distraction-free experience. Just you and your downloads." },
                speed: { title: "Priority Speed", desc: "Faster processing and downloads with dedicated infrastructure." },
            },
            earlyAccess: "Want early access? Reach out at",
            contactLink: "contact",
        },
        download: {
    ...
    bulk: {
        badge: "Bulk Downloader",
        title: "Download multiple TikTok videos at once",
        subtitle: "Paste up to 10 TikTok URLs and download them all as a ZIP — no watermark, no signup.",
        batchTitle: "Batch processing",
        batchDesc: "Paste up to 10 URLs and resolve them all in one go.",
        noWatermarkTitle: "No watermark",
        noWatermarkDesc: "Every download is clean — no TikTok logo, no overlay.",
        freeTitle: "Fast & free",
        freeDesc: "Up to 10 videos per ZIP, completely free. No account needed.",
        howToTitle: "How to use",
        step1: "Open TikTok and copy the links of the videos you want to save.",
        step2: "Paste all URLs into the box above — one per line.",
        step3: "Click \"Process Videos\" and wait for each one to resolve.",
        step4: "Hit \"Download All\" to save everything as a ZIP.",
        placeholder: "Paste TikTok URLs here, one per line:\n\nhttps://www.tiktok.com/@user/video/123...\nhttps://vm.tiktok.com/abc...",
        urlDetected: "valid URL detected",
        urlsDetected: "valid URLs detected",
        overLimit: "only first {{limit}} will process",
        maxPerZip: "Max {{max}} per ZIP",
        processBtn: "Process Videos",
        stopBtn: "Stop",
        ...
        downloadAllZip: "Download All {{count}} Videos as ZIP",
        emptyTitle: "Paste TikTok URLs above",
        emptyDesc: "Each URL on its own line — up to {{max}} per ZIP",
        ...
        faqSubtitle: "Everything you need to know about bulk downloading TikTok videos.",
        faq1q: "Is the TikTok bulk downloader free?",
        faq1a: "Yes, completely free. No signup, no credit card, no hidden fees. Download up to 10 TikTok videos per batch at no cost.",
        faq2q: "How many TikTok videos can I download at once?",
        faq2a: "You can download up to 10 TikTok videos per batch. All videos are automatically packaged into a single ZIP file.",
        faq3q: "Are the downloaded TikTok videos watermark-free?",
        faq3a: "Yes. All videos downloaded with Tiklink are completely clean — no TikTok watermark, no username overlay, no logo.",
        faq4q: "How do I get TikTok video links for bulk download?",
        faq4a: "Open TikTok and tap the Share button on any video, then tap 'Copy link'. Repeat for each video, then paste all links into the box above — one per line.",
        faq5q: "What format are the downloaded videos?",
        faq5a: "All TikTok videos are downloaded as MP4 files. Multiple videos are bundled into a ZIP archive for easy saving.",
        faq6q: "Can I download videos from private TikTok accounts?",
        faq6a: "No. Only publicly available TikTok videos can be downloaded. Videos from private accounts or deleted videos cannot be accessed.",
        faq7q: "Why did some videos fail during bulk download?",
        faq7a: "Videos may fail if they have been deleted, set to private, or are temporarily unavailable. Try processing the failed URLs again individually.",
        faq8q: "Do I need to create an account to use the bulk downloader?",
        faq8a: "No account needed. The Tiklink bulk downloader is available to everyone instantly, for free, with no registration required.",
    },
    nav: {
        download: "Download",
        tools: "Tools",
        ...
        openMenu: "Open menu",
        toolItems: {
            bulk: { title: "Bulk Download", desc: "Download multiple videos at once" },
            captions: { title: "AI Captions", desc: "Generate viral captions with AI" },
            hashtags: { title: "Hashtags", desc: "Trending tags for any niche" },
            mp3: { title: "Video to MP3", desc: "Extract audio from any video" },
        }
    }
  };
